...
import { Code, Layout, Bot, Terminal, Database, Globe } from "lucide-react";
...
export const FEATURED_PROJECTS: Project[] = [
  {
    ...
    problem:
      "Need for a comprehensive system to track shipments from China to Kazakhstan with admin management.",
  ...
  },
  {
    ...
    problem:
      "Improving customer response times and automating sales lead management for an online store.",
  ...
  },
  {
    ...
    problem:
      "Internal management tool requiring a robust backend dashboard system.",
  ...
  },
  {
    ...
    problem:
      "High-performance marketing site needed for desktop and mobile users.",
...
export const OTHER_PROJECTS: OtherProject[] = [
  {
    title: "Jelpost",
    description:
      "International logistics and shipping platform for global delivery services.",
  ...
  },
  {
    ...
    description:
      "E-commerce platform prototype featuring a comprehensive backend dashboard system.",
